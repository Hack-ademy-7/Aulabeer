...
var deleteButtons = document.getElementsByClassName("btnDelete"); // console.log(deleteButtons)
...
try {
  var _loop = function _loop() {
    ...
    var form = btn.parentElement; // asociar el evento del click al boton

    btn.addEventListener('click', function (e) {
      // parar el comportamiento por defecto (submit)
      e.preventDefault(); // enseñar un alert de confirmación 
